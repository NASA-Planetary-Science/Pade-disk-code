      subroutine zeroin(ax,bx,f,tol,root)
      double precision ax,bx,f,tol,root
c
...
c
      ...
      if (fa*fb .gt. 0.0d0) then
         print *, ' zeroin: f(a) and f(b) not of opposite sign'
         return
      end if
c
c begin step
...
c         print *, ' type 1 return'
c         print *, ' b = ', b
          go to 90
      end if

      if (fb .eq. 0.0d0) then
c         print *, ' type 2 return'
c         print *, ' b = ', b
          go to 90
      end if
c
