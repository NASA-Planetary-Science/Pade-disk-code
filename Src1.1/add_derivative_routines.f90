...
! Differentiate the fluxes in phi.  Note: We have an extra un-needed one for the isothermal case:
...
! Currently. this subroutine is not called by anyone.  I think I used it for
! debugging.
