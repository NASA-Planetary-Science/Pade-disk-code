...
! issue a warning about a possible uninitialization.
sx   = 1
sz_x = 1
...
Do py = 0, ng2 - 1
   ...
   Do px = 0, ng1 - 1
      ...
      End If
   End Do
   ! Args:  Starting group, size of new group, list of ranks in new group, new group
   call mpi_group_incl (mpi_group_world, ng1, group_ranks, mpi_group_scratch, ierror)
   ! Create new comm from new group
